...
/**
 * https://github.com/Kennyc1012/MultiStateView/blob/master/library/src/main/java/com/kennyc/view/MultiStateView.java
 * <p>
 * <p>
...
public class MultiStateView extends FrameLayout {
    ...
    private void init() {
        ...
        mLoadingViewResId = R.layout.view_state_loading;
        mEmptyViewResId = mErrorViewResId = R.layout.view_state_error;
        mViewState = VIEW_STATE_CONTENT;
    }

    /**
     * Called from {@link MultiStateRecyclerView} to setup {@link AttributeSet} with {@link MultiStateView}
     *
     * @param attrs                  get user desired settings for {@link MultiStateView}
     * @param multiStateRecyclerView
     */
    public void setInitialSetting(AttributeSet attrs, int[] multiStateRecyclerView) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, multiStateRecyclerView);
        mLoadingViewResId = a.getResourceId(R.styleable.MultiStateRecyclerView_msr_loadingView, mLoadingViewResId);
        mEmptyViewResId = a.getResourceId(R.styleable.MultiStateRecyclerView_msr_emptyView, mEmptyViewResId);
        mErrorViewResId = a.getResourceId(R.styleable.MultiStateRecyclerView_msr_errorView, mErrorViewResId);
        int viewState = a.getInt(R.styleable.MultiStateRecyclerView_msr_viewState, mViewState);
        mAnimateViewChanges = a.getBoolean(R.styleable.MultiStateRecyclerView_msr_animateViewChanges, false);
